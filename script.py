...
Nesse caso, e partindo do princípio que o plano foi bem sucedido, são informações importantes para a predição da sobrevivência "Pclass", "Sex_cleaned", "Fare" e "Embarked_cleaned", pois são as características importantes para demarcar dos "homens mais ricos do mundo". A performance média deste modelo é dada por:

Media:  77.4528037383
de:  74.9522142803
ate:  79.9533931963

Além disso, este modelo classifica os nomes citados como sobreviventes. Logo, esta teoria é estatísticamente improvável
...
print gnb.predict(data[used_features])
